...
#define BLE_UUID_NUS_TX_CHARACTERISTIC 0x5343                      /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC 0x5343                      /**< The UUID of the RX Characteristic. */
...
#define RX_BASE_UUID                  {{0xb3, 0x9b, 0x72, 0x34, 0xbe, 0xec, 0xd4, 0xa8, 0xf4, 0x43, 0x41, 0x88, 0x43, 0x53, 0x53, 0x49}} /**< Used vendor specific UUID. */
#define TX_BASE_UUID                  {{0x16, 0x96, 0x24, 0x47, 0xc6, 0x23, 0x61, 0xba, 0xd9, 0x4b, 0x4d, 0x1e, 0x43, 0x53, 0x53, 0x49}} /**< Used vendor specific UUID. */
...
static uint32_t tx_char_add(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
    ...
    ble_gatts_attr_md_t attr_md;
	  ble_uuid128_t tx_base_uuid = TX_BASE_UUID;
...
static uint32_t rx_char_add(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
    ...
    ble_uuid_t          ble_uuid;
    ble_gatts_attr_md_t attr_md;
	  ble_uuid128_t rx_base_uuid = RX_BASE_UUID;
    ...
    ble_uuid.uuid = BLE_UUID_NUS_TX_CHARACTERISTIC;
	  err_code = sd_ble_uuid_vs_add(&rx_base_uuid, &ble_uuid.type);
    VERIFY_SUCCESS(err_code);
